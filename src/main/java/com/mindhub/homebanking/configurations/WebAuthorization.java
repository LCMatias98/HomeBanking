...
public class WebAuthorization{
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http.authorizeRequests()
                ...
                .antMatchers("/api/accounts.html","/web/accounts.html","/web/transfer.html","/web/account.html","/web/loan-aplication.html","/web/cards.html","/web/create-cards.html","/web/news.html","/web/aboutUs.html","/api/clients/current").hasAuthority("CLIENT")
                .antMatchers("/h2-console/**","/rest/**","/web/**","/api/accounts.html").hasAuthority("ADMIN")
                .antMatchers(HttpMethod.POST,"/api/clients/current/account","/api/loans","/api/clients/current/cards","api/transactions").hasAuthority("CLIENT")
